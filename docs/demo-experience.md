...
| --- | --- | --- |
| System check | Consent, remain quiet, then speak naturally. | Room, speech, framing, pose, and light reach Ready. |
...
- Agent lanes show current responsibilities and modality independence.
- Only the six most recent workflow events remain visible.
- Results contain measured signals and the clinician encounter summary.
